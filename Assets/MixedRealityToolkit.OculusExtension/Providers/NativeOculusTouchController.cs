...
// Licensed under the MIT License. See LICENSE in https://github.com/microsoft/MixedRealityToolkit-Unity/blob/mrtk_release/License.txt for license information.
...
namespace Microsoft.MixedReality.Toolkit.Oculus.Input
{
    ...
    public class NativeOculusTouchController : BaseOculusController
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public NativeOculusTouchController(TrackingState trackingState, Handedness controllerHandedness,
